...
var apikey = '11834781bff000825b4dad5de1ccaa19'
...
// const API_KEY = '5203b878159c753505add3f481eef131';
...
//   useEffect(() => {
//     fetch(
//      ' https://api.openweathermap.org/data/2.5/weather?q=bhatkal&appid='+API_KEY
//     )
//       .then(response => response.json())
//       .then(json => {
//         setData(json);
//         setUrl('https://openweathermap.org/img/wn/'+json.+'@2x.png');
//       })
...
//                         .then(json => {
//                           setData(json);
//                           setUrl(json.current.weather_icons[0]);
//                         })
...
//                     wind speed {'\n'} {data.current.wind_speed} kmph
//                   </Text>
//                   <Text style={styles.bottomBlocks}>
//                     humudity {'\n'} {data.current.humidity} %
//                   </Text>
//                   <Text style={styles.bottomBlocks}>
//                     pressure {'\n'} {data.current.pressure / 1000} bar
//                   </Text>
//                 </View>
//               </View>
//             </View>
